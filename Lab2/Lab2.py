...
def main():
    ...
    image.save("E:\\WorkSpace\\Python\\DPS\\Lab2\\Lab2\\Images\\DissectedImage.png",)
    ...
    while 1:
        try:
            ...
            if numberOfClusters < 2 or numberOfClusters > size:
                raise Exception("Number of clusters cannot be less than two or greater than number of objects in the photo")
            break
        except Exception as exp:
            print("Error: " + str(exp))
